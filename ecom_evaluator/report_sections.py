...
REPORT_SECTIONS: tuple[ReportSection, ...] = (
    ...
    ReportSection(
        ...
        eyebrow="Section 3 · Finance",
        subtitle="Python-calculated margins, ROI, break-even CPA, and volume projections",
        min_tier=PlanTier.FREE,
    ),
    ReportSection(
        id="marketing_teaser",
        number=4,
        title="Audience & Marketing Viability Teaser",
        eyebrow="Section 4 · Marketing",
        subtitle="Channel fit, hook potential, and buyer persona — no scripts yet",
        min_tier=PlanTier.FREE,
    ),
    ReportSection(
        id="web_intelligence",
