...
/* Theme switcher — compact pill strip (custom buttons for reliable contrast) */
...
.stApp:has(.cm-workspace) div[class*="st-key-ws_theme_pick_"] .stButton > button,
...
.stApp:has(.cm-workspace) div[class*="st-key-ws_theme_pick_"] button[data-testid="stBaseButton-secondary"] p,
...
.stApp:has(.cm-workspace) div[class*="st-key-ws_theme_pick_"] button[data-testid="stBaseButton-primary"] p {
