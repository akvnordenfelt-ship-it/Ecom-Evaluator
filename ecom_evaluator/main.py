...
from ecom_evaluator.ui.form import render_app_header, render_evaluation_form, render_hero
from ecom_evaluator.ui.session import (
    friendly_analysis_error,
    init_session_state,
    mark_analysis_for_rate_limit,
    rate_limit_banner_text,
    validate_inputs,
)
            ...
            if errors:
                ...
                try:
                    ...
                    st.error(
                        ...
                        "**Tip:** Check your internet connection and API key, then try again."
                    )
                finally:
